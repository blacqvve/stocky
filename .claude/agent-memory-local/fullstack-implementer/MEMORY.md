...
## Project
- [project_stocky.md](./project_stocky.md) — Core architecture, stack, file conventions, and domain layout for the Stocky electronics inventory project

## Frontend
- [frontend/src/app/_frontend-foundation.memory.md](../../frontend/src/app/_frontend-foundation.memory.md) — Phase 2 frontend foundation: API client, UI components, Sidebar layout, Dashboard page
